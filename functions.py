...
def calculate_shoulder_angle_SMPL(data, frame):
    ...
    spine_chest = [data.iloc[frame]['spine_chest_x'], data.iloc[frame]['spine_chest_y'], data.iloc[frame]['spine_chest_z']] #spine_chest
...
def spine_arc_SMPL(data, frame):
    top_spine = [data.iloc[frame]['spine_chest_x'], data.iloc[frame]['spine_chest_y'], data.iloc[frame]['spine_chest_z']] #spine_chest
...
def calculate_pelvis_flexion_SMPL(data, frame):
    chest = [data.iloc[frame]['spine_chest_x'], data.iloc[frame]['spine_chest_y'], data.iloc[frame]['spine_chest_z']] #spine_chest
